...
def build_user_prompt(
    ...
    if style == PROMPT_STYLE_NATURAL:
        prompt_rule = (
            ...
            "段首先锁人数：画面里只有 N 个人。禁止用玻璃倒影、married/丈夫/妻子、走廊路人把两人写成三人、三人写成四人。"
        ...
        prompt_rule = (
            ...
            "人数 tag 必须精确；禁止 reflection / married / wife / husband / crowd 把人数加一；公共场景补 empty, no_crowd。"
    ...
    return (
        ...
        "防人数膨胀：在场几人就只写几人；玻璃/镜子只写光斑不写人物倒影；锁定外貌禁止 married/妻子/丈夫；走廊办公室默认空场。\n"
